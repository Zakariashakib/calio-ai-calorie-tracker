...
- [CalSnap image storage](calsnap-image-storage.md) — meal photos stored as base64; full images recompressed (max 1280px, q75) on save + lazily for old meals via image_optimized flag; needs Pillow.
