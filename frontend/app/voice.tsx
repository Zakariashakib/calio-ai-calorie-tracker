  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.privacy}><Ionicons name="shield-checkmark" size={17} color={colors.greenDark} /><Text style={styles.privacyText}>Audio is processed only to create your meal log.</Text></View>
      </View>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.canvas }, header: { height: 66, paddingHorizontal: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, iconButton: { width: 44, height: 44, borderRadius: 17, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" }, headerTitle: { color: colors.ink, fontSize: 17, fontWeight: "800" }, content: { flex: 1, alignItems: "center", paddingHorizontal: 24, paddingBottom: 22 }, copy: { alignItems: "center", gap: 9, marginTop: 25 }, kicker: { color: colors.greenDark, fontSize: 11, letterSpacing: 1.5, fontWeight: "800" }, title: { color: colors.ink, fontSize: 30, fontWeight: "900", textAlign: "center" }, subtitle: { maxWidth: 310, color: colors.muted, fontSize: 14, lineHeight: 21, textAlign: "center" }, visual: { height: 155, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 35 }, wave: { width: 7, borderRadius: 5, backgroundColor: colors.green }, timer: { fontSize: 18, color: colors.muted, fontWeight: "700", fontVariant: ["tabular-nums"] }, record: { width: 82, height: 82, borderRadius: 41, backgroundColor: colors.dark, alignItems: "center", justifyContent: "center", marginTop: "auto", shadowColor: colors.greenDark, shadowOpacity: 0.2, shadowRadius: 20, elevation: 6 }, recordActive: { backgroundColor: colors.peach }, hint: { color: colors.muted, fontSize: 12, marginTop: 12 }, privacy: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: colors.greenSoft, borderRadius: radius.pill, paddingHorizontal: 13, paddingVertical: 9, marginTop: 25 }, privacyText: { color: colors.greenDark, fontSize: 11, fontWeight: "600" },
});
