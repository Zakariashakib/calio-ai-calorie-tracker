...
const styles = StyleSheet.create({
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, back: { width: 44, height: 44, borderRadius: 17, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" }, headerTitle: { color: colors.ink, fontSize: 17, fontWeight: "800" }, profile: { backgroundColor: colors.dark, borderRadius: radius.lg, padding: 20, flexDirection: "row", alignItems: "center", gap: 13 }, avatar: { width: 58, height: 58, borderRadius: 21, backgroundColor: colors.greenSoft, alignItems: "center", justifyContent: "center" }, initial: { color: colors.greenDark, fontSize: 24, fontWeight: "900" }, profileCopy: { flex: 1, gap: 4 }, name: { color: "white", fontSize: 18, fontWeight: "900" }, email: { color: "#AEB3AB", fontSize: 11 }, premium: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#333832", borderRadius: radius.pill, paddingHorizontal: 9, paddingVertical: 6 }, premiumText: { color: "white", fontSize: 9, fontWeight: "700" }, section: { color: colors.muted, fontSize: 10, letterSpacing: 1.5, fontWeight: "800" }, card: { backgroundColor: colors.surface, borderRadius: radius.lg, paddingHorizontal: 16, ...shadow }, row: { minHeight: 76, flexDirection: "row", alignItems: "center", gap: 12 }, border: { borderBottomWidth: 1, borderBottomColor: colors.line }, icon: { width: 42, height: 42, borderRadius: 15, backgroundColor: colors.greenSoft, alignItems: "center", justifyContent: "center" }, rowCopy: { flex: 1, gap: 4 }, rowTitle: { color: colors.ink, fontSize: 15, fontWeight: "800" }, rowDetail: { color: colors.muted, fontSize: 11 }, health: { flexDirection: "row", alignItems: "flex-start", gap: 12, backgroundColor: colors.greenSoft, borderRadius: radius.md, padding: 16 }, healthCopy: { flex: 1, gap: 5 }, healthTitle: { color: colors.greenDark, fontSize: 14, fontWeight: "800" }, healthText: { color: colors.muted, fontSize: 11, lineHeight: 17 }, logout: { height: 54, borderRadius: radius.pill, backgroundColor: colors.surface, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, logoutText: { color: colors.red, fontSize: 15, fontWeight: "800" },
});
