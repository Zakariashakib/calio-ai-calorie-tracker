...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.canvas }, flex: { flex: 1 }, header: { height: 66, paddingHorizontal: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, iconButton: { width: 44, height: 44, borderRadius: 17, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" }, headerTitle: { color: colors.ink, fontSize: 17, fontWeight: "800" }, content: { padding: 20, paddingBottom: 45, gap: 18 }, current: { alignItems: "center", gap: 6, paddingVertical: 12 }, kicker: { color: colors.greenDark, fontSize: 11, letterSpacing: 1.4, fontWeight: "800" }, currentValue: { color: colors.ink, fontSize: 43, fontWeight: "900" }, unit: { color: colors.muted, fontSize: 16 }, change: { color: colors.muted, fontSize: 12 }, range: { flexDirection: "row", backgroundColor: colors.surface, padding: 4, borderRadius: radius.pill }, rangeButton: { height: 38, flex: 1, borderRadius: 19, alignItems: "center", justifyContent: "center" }, rangeActive: { backgroundColor: colors.dark }, rangeText: { color: colors.muted, fontSize: 12, fontWeight: "700" }, rangeTextActive: { color: "white" }, chart: { minHeight: 240, backgroundColor: colors.surface, borderRadius: radius.lg, padding: 18, justifyContent: "center", overflow: "hidden", ...shadow }, points: { height: 190, flexDirection: "row", alignItems: "flex-end", justifyContent: "space-around" }, pointColumn: { flex: 1, alignItems: "center", justifyContent: "flex-end", gap: 5 }, pointValue: { color: colors.ink, fontSize: 9, fontWeight: "700" }, stem: { width: 4, backgroundColor: colors.greenSoft, justifyContent: "flex-start", alignItems: "center", borderRadius: 3 }, point: { width: 13, height: 13, borderRadius: 7, backgroundColor: colors.green, marginTop: -4 }, pointDate: { color: colors.muted, fontSize: 8 }, empty: { alignItems: "center", gap: 9 }, emptyText: { color: colors.muted, fontSize: 13 }, form: { backgroundColor: colors.greenSoft, borderRadius: radius.lg, padding: 18, gap: 15 }, formTitle: { color: colors.ink, fontSize: 17, fontWeight: "900" }, formHint: { color: colors.muted, fontSize: 11, marginTop: 4 }, inputRow: { backgroundColor: colors.surface, borderRadius: radius.md, flexDirection: "row", alignItems: "center", paddingLeft: 15 }, input: { flex: 1, height: 54, color: colors.ink, fontSize: 20, fontWeight: "800" }, kg: { color: colors.muted, fontSize: 12 }, add: { width: 46, height: 46, borderRadius: 17, backgroundColor: colors.greenDark, alignItems: "center", justifyContent: "center", marginHorizontal: 4 },
});
