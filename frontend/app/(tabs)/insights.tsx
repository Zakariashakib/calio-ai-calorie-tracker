...
export default function InsightsScreen() {
  ...
  if (loading || !report || !dashboard) return <AppScreen><ActivityIndicator size="large" color={colors.green} /></AppScreen>;
...
const styles = StyleSheet.create({
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, kicker: { color: colors.greenDark, fontSize: 11, letterSpacing: 1.5, fontWeight: "800" }, title: { color: colors.ink, fontSize: 31, fontWeight: "900", letterSpacing: -0.8 }, export: { width: 46, height: 46, borderRadius: 17, backgroundColor: colors.surface, alignItems: "center", justifyContent: "center" }, metricRow: { gap: 10, paddingVertical: 4 }, chartCard: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: 20, gap: 18, ...shadow }, sectionRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, section: { color: colors.ink, fontSize: 19, fontWeight: "900" }, small: { color: colors.muted, fontSize: 12, lineHeight: 17 }, goal: { color: colors.greenDark, backgroundColor: colors.greenSoft, paddingHorizontal: 10, paddingVertical: 6, borderRadius: radius.pill, fontSize: 10, fontWeight: "800" }, chart: { height: 155, flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between" }, barColumn: { height: 150, width: 28, justifyContent: "flex-end", alignItems: "center", gap: 7 }, bar: { width: 16, borderRadius: 8 }, day: { fontSize: 10, color: colors.muted, fontWeight: "700" },
